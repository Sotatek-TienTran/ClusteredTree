...
public class GraphMethods {
	...
	// public double[][] prim(double[][] weight_Matrix, int num_Verties, Random
	// rnd) {
	// int rnd_Verties = -1;
	...
	// } else {
	// for (int v : V_Vh) {
	// if ((d[v] > weight_Matrix[idx_Min_Vertex][v]) &&
	// (weight_Matrix[idx_Min_Vertex][v] > 0)) {
	...
	// //
	// public void dem_So_Thanh_Phan_Lien_Thong(double[][] weigh_Matrix, int
	// num_Vertex) {
